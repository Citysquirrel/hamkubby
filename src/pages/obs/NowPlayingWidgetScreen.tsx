...
import { NowPlayingWidgetView } from "./lib/comp";

const SOCKET_URL = API_BASE_URL;
type ConnectionStatus = "loading" | "connected" | "error";

export default function NowPlayingWidgetScreen() {
	useMeta({ title: "현재 재생 곡 위젯" });
	...
	return (
		<Box w="100vw" h="100vh" bg="transparent" p={6} overflow="hidden">
         ...
         `}</style>
			<NowPlayingWidgetView settings={settings!} songList={songList} />
		</Box>
	);
}
